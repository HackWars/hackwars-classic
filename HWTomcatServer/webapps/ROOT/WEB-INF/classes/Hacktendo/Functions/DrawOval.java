...
public class DrawOval extends LinkerFunctions{

	private RenderEngine RE;
	private HacktendoLinker HL;
	public DrawOval(RenderEngine RE,HacktendoLinker HL){
		this.RE=RE;
		this.HL=HL;
	}
	...
	public Object execute(ArrayList parameters){
		...
		if(a<0)
			a=0;
		Object O[] = new Object[]{RenderEngine.OVAL,new Integer(x),new Integer(y),new Integer(width),new Integer(height),new Integer(r),new Integer(g),new Integer(b),new Integer(a)};
		RE.addGraphics(O);
		return null;
	}
}
