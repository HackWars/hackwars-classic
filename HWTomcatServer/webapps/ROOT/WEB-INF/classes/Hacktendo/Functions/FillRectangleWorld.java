...
public class FillRectangleWorld extends LinkerFunctions{

	private OpenGLRenderEngine RE;
	private HacktendoLinker HL;
	public FillRectangleWorld(RenderEngine RE,HacktendoLinker HL){
	...
	public Object execute(ArrayList parameters){
		...
		if(a<0)
			a=0;
		Object O[] = new Object[]{OpenGLRenderEngine.FILL_RECTANGLE_WORLD,new Integer(x),new Integer(y),new Integer(width),new Integer(height),new Integer(r),new Integer(g),new Integer(b),new Integer(a),new Integer(z)};
		RE.addGraphics(O);
		return null;
	}
}
