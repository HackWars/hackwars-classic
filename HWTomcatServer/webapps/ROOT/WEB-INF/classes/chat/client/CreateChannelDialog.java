...
public class CreateChannelDialog extends JDialog implements ActionListener{
	...
	private JButton ok=new JButton("Create"), cancel=new JButton("Cancel");
	public CreateChannelDialog(ChatController controller){
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==ok){
			try{
				controller.sendChannelCreate(nameField.getText(),passwordField.getText());
			}catch(Exception ex){}
			setVisible(false);
		}
