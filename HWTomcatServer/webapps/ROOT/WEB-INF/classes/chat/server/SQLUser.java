...
public class SQLUser {
    ...
    static User createUser(sql s, String userName, String userNick)throws Exception{
        String cmd = "insert into " + USER_TABLE 
                + "(" + USER_NAME + "," + USER_NICK + ")"
                + " values('" + userName + "','" + userNick + "')";
        
        s.processUpdate(cmd);
        return new User(userName,userNick,null);
    }
     ...
     */
    static User getSqlData(sql s, String userName) throws Exception{
        ...
        return new User(userName, userNick, prop);
