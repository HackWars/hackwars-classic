...
public class ScriptEditorCellRenderer extends JLabel implements ListCellRenderer{
	
	private Object[] directory;
	private HackerFileChooser MyScriptEditor; 
	public ScriptEditorCellRenderer(Object[] directory,HackerFileChooser MyScriptEditor){
	...
	if(directory!=null){
		...
		if (isSelected) {
		    if(MyScriptEditor!=null)	
			    MyScriptEditor.setSaveField(pet);
